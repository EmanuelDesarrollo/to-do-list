...
import { add, checkboxOutline, createOutline, moonOutline, pricetagOutline, sunnyOutline, trashOutline } from 'ionicons/icons';
...
addIcons({ add, checkboxOutline, createOutline, moonOutline, pricetagOutline, sunnyOutline, trashOutline });
